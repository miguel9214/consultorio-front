                            ...
                            <template #acciones="props">
                                <div class="mb-4 me-2 custom-dropdown dropdown btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="pendingTask">
                                        <li>
                                            <router-link :to="{ name: 'invoices-edit', params: { id: props.row.id } }"
                                                class="dropdown-item acciones-edit"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <li>
                                            <a href="javascript:void(0);" @click="delete_row(props.row.id)"
                                                class="dropdown-item acciones-delete"><svg
