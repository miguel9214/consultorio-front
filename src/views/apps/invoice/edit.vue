                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="dropdown selectable-dropdown invoice-select d-block btn-group">
                                            <a href="javascript:;" id="ddlCurrency" class="btn dropdown-toggle btn-icon-only text-nowrap" data-bs-toggle="dropdown" aria-expanded="false">
                                                <img :src="'/src/assets/images/' + selected_currency.thumb" class="flag-width" alt="flag" />
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="ddlCurrency">
                                                <li v-for="(item, index) in currency_list" :key="index">
                                                    <a href="javascript:;" class="dropdown-item" @click="selected_currency = item"> <img :src="'/src/assets/images/' + item.thumb" class="flag-width" alt="flag" /> {{ item.key }} </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
...
<script setup>
    ...
    const items = ref([]);
    const selected_file = ref("/src/assets/images/cork-logo.png");
    const params = ref({
        title: "Cork Inc.",
        invoice_no: "#0001",
