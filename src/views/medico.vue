                        ...
                        <div class="col-md-6">
                            <div id="username-field" class="field-wrapper input mt-2">
                                <select v-model="selectedSpeciality" class="form-select w-100" tabindex="14">
                                    ...
                                    <option :value="{ id: speciality.id, name: speciality.name }" :key="speciality.id" v-for="speciality in specialtyList">{{ speciality.name }}</option>
                                </select>
                            ...
                            <tbody>
                                <tr v-for="(item, index) in formData.specialities" :key="index">
                                    ...
                                    <td class="description">
                                        <input type="text" v-model="item.name" class="form-control form-control-sm" placeholder="Item Description" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
