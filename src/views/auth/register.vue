                ...
                <div class="form-form-wrap">
                    <div class="form-container">
                        <div class="form-content">
                            ...
                            <p class="signup-link text-center">Ya tienes una cuenta? <router-link to="/auth/login">Ingresar</router-link></p>
                            <div class="row">
                                <div class="col-md-6">
                                    <form class="text-start">
                                        <div class="form">
                                            ...
                                            <div id="username-field" class="field-wrapper input">
                                                ...
                                                <input v-model="formData.first_name" type="text" class="form-control" placeholder="Nombre(s)" tabindex="3" />
                                            </div>
                                            <!-- Telefono -->
                                            <div id="username-field" class="field-wrapper input">
                                                <svg
                                                ...
                                                <input v-model="formData.phone" type="text" class="form-control" placeholder="Teléfono" tabindex="5" />
                                            </div>
                                            <!-- Fecha de Nacimiento -->
                                            <div id="username-field" class="field-wrapper input">
                                                <svg
                                                ...
                                                <input v-model="formData.birthdate" type="text" class="form-control" placeholder="Fecha de Nacimiento" tabindex="7" />
                                            </div>
                                            <!-- Ciudad -->
                                    ...
                                    <form class="text-start">
                                        <div class="form">
                                            ...
                                            <div id="username-field" class="field-wrapper input">
                                                ...
                                                <input v-model="formData.document" type="text" class="form-control" placeholder="Documento" tabindex="2" />
                                            </div>
                                            <!-- Apellidos -->
                                            <div id="username-field" class="field-wrapper input">
                                                <svg
                                                ...
                                                <input v-model="formData.last_name" type="text" class="form-control" placeholder="Apellido(s)" tabindex="4" />
                                            </div>
                                            <!-- Sexo -->
                                            ...
                                            <div id="email-field" class="field-wrapper input">
                                                ...
                                                <input v-model="formData.email" type="email" class="form-control" placeholder="Correo" tabindex="8" />
                                            </div>
                                            <!-- Departamento -->
                                            <div id="region-field" class="field-wrapper input">
                                                ...
                                                >
                                                    <!-- Marcador de mapa -->
                                                    <path d="M12 2C9.79 2 8 3.79 8 6a4 4 0 0 0 8 0c0-2.21-1.79-4-4-4zM12 14c-2.21 0-4-1.79-4-4 0-3.48 4-9 4-9s4 5.52 4 9c0 2.21-1.79 4-4 4z"></path>
                                                    <circle cx="12" cy="10" r="2"></circle>
                                                </svg>
                                                <input v-model="formData.state" type="text" class="form-control" placeholder="Región" tabindex="10" />
                                            </div>
                                            <!-- Barrio -->
                                            <div id="city-field" class="field-wrapper input">
                                                <svg
                            ...
                            <p class="terms-conditions">
                                © 2024 Todos los derechos reservados. <router-link to="/">CORK</router-link> es un producto de Arrangic Solutions LLP.
                                <a href="javascript:void(0);">Preferencias de cookies</a>, <a href="javascript:void(0);">Privacidad</a>, y <a href="javascript:void(0);">Terminos</a>.
                            </p>
                        </div>
                    </div>
                </div>
