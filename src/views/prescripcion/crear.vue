                                    ...
                                    <div id="ct" class="">
                                        <div class="invoice-00001">
                                            <div class="content-section">
                                                <div class="inv--head-section inv--detail-section">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3 text-sm-end">
                                                            <p class="inv-street-addr">Fecha: <span id="current-date"
                                                                    class="">{{ formattedDate }}</span></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="inv--product-table-section">
                                                    <div class="table-responsive">
                                                        <table class="table table-hover">
                                                            ...
                                                            <tbody>
                                                                <tr v-for="(prescription, index) in prescriptionList"
                                                                    :key="index">
                                                                    <td>{{ index + 1 }}</td>
                                                                    ...
                                                                    <td class="text-end">{{
                                                                        prescription.additional_instructions }}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                ...
                                                <div class="modal fade" id="modalEditarPrescripcion" tabindex="-1"
                                                role="dialog" aria-labelledby="exampleModalLabel"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-xl" role="document">
                                                    <div class="modal-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-md-3 col-sm-6">
                                            <a href="javascript:;" class="btn btn-primary btn-send"
                                                data-bs-toggle="modal" data-bs-target="#modalEditarPrescripcion" @click="viewPrescription(id)">Editar
                                                Prescripcion</a>
                                        </div>
                                        <div class="col-xl-12 col-md-3 col-sm-6">
...
const viewPrescription = async (id) => {
    try {
        const { data, message } = await useApi('prescriptionConsultation/' +id);
